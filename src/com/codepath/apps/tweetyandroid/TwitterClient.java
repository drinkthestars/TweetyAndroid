...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "UC0mjI4wSj61PkXBxf4Dw";       // Change this
    public static final String REST_CONSUMER_SECRET = "6YJNgtcTS2MKFMJIvNdizqp31Rky00I3pGCFWUxd51s"; // Change this
    ...
    public void getHomeTimeline(long max_id, AsyncHttpResponseHandler handler) {
    	String url = getApiUrl("statuses/home_timeline.json");//automatically puts the base url with resource url
    	RequestParams params = new RequestParams();
    	if (max_id != 0) {
